 ...
 */
public class Trigger extends AbstractObject {
    ...
    private String channelId = ChannelConstants.CHANNEL_DEFAULT;
    
    private String reloadChannelId = ChannelConstants.CHANNEL_RELOAD;
