...
public class TriggerHistory implements Serializable {
    ...
    public TriggerHistory(Table table, Trigger trigger, DialectService dialectService) {
        this(table, trigger, dialectService, null);
    }

    public TriggerHistory(Table table, Trigger trigger, DialectService dialectService, String reason) {
        this();
        ...
        this.triggerTemplateHash = dialectService.getTriggerTemplatesHashCode();
    ...
    public String toString() {
        return Integer.toString(triggerHistoryId);
    }
